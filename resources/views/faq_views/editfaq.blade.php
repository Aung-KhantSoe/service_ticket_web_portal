      ...
      <div class="edit-profile">
        <div class="row">
          <div class="col-xl-12">
            ...
            @endif
            <form class="card" action="{{ route('faqs.update', ['faq' => $faq->id])}}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" name="question" cols="30" rows="3" required>{{ $faq->question }}</textarea>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="product_id">
                            ...
                            <option  value="{{ $product->id }}" @if($product->id == $faq->product_id) selected @endif>{{ $product->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
