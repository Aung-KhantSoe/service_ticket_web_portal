$(document).ready(function() {
    ...
    // wpa edited for date data sorting
    //$.fn.dataTable.moment('d-m-Y');
    /* jQuery.extend(jQuery.fn.dataTableExt.oSort, {
        "extract-date-pre": function(value) {
            console.log("data is >> "+ value);
            var date = $(value)[5].innerHTML;
            date = date.split('-');
            //alert('here');
            console.log(date[2]);
    ...
    jQuery.extend( jQuery.fn.dataTableExt.oSort, {
        "date-eu-pre": function ( date ) {
            ...
            if(eu_date[3] != null && eu_date[3] != "" 
                && eu_date[4] != null && eu_date[4] != ""
                && eu_date[5] != null && eu_date[5] != ""){
                //hour
                hour = eu_date[3];
                if(hour == 0 || hour == '00'){
                    hour = 24;
            ...
            console.log((year + month + day + hour + min + sec) * 1);
    ...
    $('#s1dob').blur(function(){
        var dat2 = new Date();
        var dat1 = new Date($('#s1dob').val());
        $('#s1age').val(yearDiff(dat1,dat2));
    });
